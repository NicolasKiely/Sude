...
public class CmdSelling extends SudeCommand{
	...
	public boolean execute(CommandSender originalSender,
		...
		if (args.length == 0){
			...
			String[] itemList = Sude.sellList.getItems();
			...
			/* Show the list of sellers for the item */
			String[] itemList = Sude.sellList.listItem(args[0], true);
			
			String itemString = "Sellers for: " + args[0];
			for (String item : itemList){
				itemString += "\n" + item;
			}
