...
/**
 * Player Selling command
 * @author Metalmeerkat
 */
public class CmdPlayerSelling extends SudeCommand{
	
	/**
	 * Construct command
	 */
	public CmdPlayerSelling(){
		super("player-selling","ps");
	}
	...
	public boolean execute(CommandSender originalSender,
		...
		Talker.render(originalSender, Sude.sellList.getItems(owner), ", ");
